package com.tergech.nix.tictactoe;
...
public class _5by5_board extends AppCompatActivity {
    ...
    public void endGame() {
        ...
        if (a.equals("O") && b.equals("O") && c.equals("O") && d.equals("O") && e.equals("O")) {
            Toast.makeText(this, "Bingo O is winner", Toast.LENGTH_SHORT).show();
            end = true;
            playerOWon++;
        }
        ...
        if((!a.isEmpty() && !b.isEmpty() && !c.isEmpty() && !d.isEmpty() && !e.isEmpty() && !f.isEmpty()
                && !g.isEmpty() &&!h.isEmpty() && !i.isEmpty() &&!j.isEmpty() &&!k.isEmpty()
                &&!l.isEmpty() && !m.isEmpty() &&!n.isEmpty()
                &&o.isEmpty() &&!p.isEmpty() &&!q.isEmpty()&&!r.isEmpty() &&!s.isEmpty() &&!t.isEmpty()
                &&!u.isEmpty() &&!v.isEmpty() &&!w.isEmpty() &&!x.isEmpty()&&!y.isEmpty()))
        {
            Toast.makeText(this, "Ooops No one Wins", Toast.LENGTH_SHORT).show();
            end = true;
        }
